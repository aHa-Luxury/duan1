...
INSERT INTO `binhluan` VALUES (3,'123',10,2),(4,'San pham ok',9,2),(5,'good',9,2),(6,'okk',30,2),(7,'Nice',28,2);
...
CREATE TABLE `chitietbill` (
  ...
  CONSTRAINT `fk_bill` FOREIGN KEY (`id_bill`) REFERENCES `bill` (`id_bill`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `khachhang` VALUES (1,'Đào','Hải','hdao4959@gmail.com',1,'123','Nam Dinh','098765421'),(2,'Tran  ','Loc','tranloc1234@gmail.com',0,'1','Nam Dinh kekeke','12312312321'),(6,'administrator@test.com','administrator@test.com','administrator@test.com',1,'1','','');
...
INSERT INTO `sizesanpham` VALUES (1,41,55,1),(4,13,5,38),(8,42,55,1),(10,41,3123,40),(12,40,12,42),(14,42,32,30),(15,41,32,30),(16,42,10,29);
...
-- Dump completed on 2023-11-28 20:51:54
